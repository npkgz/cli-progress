...
module.exports = {
    ...
    parse: function parse(rawOptions, preset){
        ...
        // auto expand bar width to visible window width
        options.autoExpand = mergeOption(opt.autoExpand, false);

        // necessary for auto expand and dyanmic window resize
        options.barCompleteChar = opt.barCompleteChar || '=';
        options.barIncompleteChar = opt.barIncompleteChar || '-';
